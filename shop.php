<?php
    ...
    if (!empty($_POST)) {
        ...
        if user selected a type
            sqlConditions .= 'WHERE product_type = selected_type'
        end
        if user selected a brand
            if sqlConditions is an empty string
                sqlConditions .= 'WHERE product_brand = selected_brand'
            else
                sqlConditions .= 'AND product_brand = selected_brand'
            end
        end
        */
    }
